...
# Install
apt-get update
apt-get install -y ./chromium-codecs-ffmpeg_${ARCH}.deb
apt-get install -y. /chromium-codecs-ffmpeg-extra_${ARCH}.deb
apt-get install -y ./chromium-browser_${ARCH}.deb
apt-get install -y ./chromium-chromedriver_${ARCH}.deb
